        ...
        <Fragment>
            <div className="container min-w-full flex flex-col align-middle justify-center">
                ...
                <div className="container top-50 left-50 container absolute top-50 left-50 flex flex-col min-w-full align-middle justify-center p-10">
                    <h1 className="text-4xl md:text-5xl text-rose-500 font-bold md:font-extrabold font-sans mx-auto text-center mb-6">Lorem ipsum dolor sit amet.</h1>
                    <p className="text-base text-slate-200 font-medium font-sans mx-auto text-center w-auto md:w-[620px] mb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores, mollitia! Explicabo numquam neque maiores nulla inventore non illo obcaecati fugit!</p>
                </div>
            </div>
        </Fragment>
    )
