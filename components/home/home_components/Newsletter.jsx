    ...
    return (
        <Fragment>
            <div className="container h-[600px] flex flex-col align-middle justify-center min-w-full p-10 bg-slate-100">
                ...
                <p className="text-center mx-auto text-base md:text-lg font-normal md:font-medium text-slate-500 my-2 lg:w-[700px]">Lorem ipsum dolo laudantium spernatur nobisumenda sequi aliqtaque debitis vel similique fuga. Suscipit nesciunt, molestiae ab distinctio in deleniti dolorem! Omnis.</p>
