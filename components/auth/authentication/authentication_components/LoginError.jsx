...
export default function LoginError ({error, enabled}) {
    return (
        <Fragment>
            <div className="container flex flex-row align-middle justify-center w-full bg-red-200 shadow-lg p-3 my-2 rounded-lg" style={{display: enabled}}>
                <FontAwesomeIcon icon={faExclamationTriangle} className="mx-1 my-auto mr-3 text-lg text-center text-red-500" />
